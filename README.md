...
A cross-platform mobile application designed to connect professionals within the film industry—allowing actors, directors, and producers to network, manage audition workflows, and collaborate efficiently.
...
. To run this project, clone the repository, open the folder in VS Code, execute flutter pub get in the terminal to fetch dependencies, select your device, and press F5 or run flutter run to launch the app
